        ...
        <div className="flex flex-row">
            <div className='flex flex-col items-center justify-center w-[40%]'>
                <h1 className='pt-20 text-4xl text-white'>Stavan Patel</h1>
                    ...
                    <a href={Resume} target="_blank" rel="noreferrer" class="inline-block px-5 py-2 mx-auto mt-6 text-white bg-gray-800 rounded-md border-solid border-2 hover:bg-cyan-500 hover:border-black hover:text-black md:mx-0">Resume</a>
                <div className='grid gap-8 items-start justify-center'>
                    <button className='space-x-9 mt-8 px-5 py-2 w-3bg-transparent rounded-lg leading-none flex justify-center items-center'>
                        <span>
                            <a href="https://www.linkedin.com/in/stavan-patel-b974131ba/" target="_blank" rel="noreferrer">
                        ...
                        <span>
                            <a href="https://github.com/stavan30" target="_blank" rel="noreferrer">
